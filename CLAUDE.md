...
|---------|-----------|--------|------|--------|
| 市場データ | 仮想アシスタント市場、AIスケジューラー、生産性ツール | 調査レポート | 月1回 | data/collected/market/ |
| 競合情報 | x.ai, Clara, Calendly, Motion, Reclaim | 競合サイト | 週1回 | data/collected/competitor/ |
| 技術動向 | Google API, Microsoft Graph, OAuth 2.0, LLM Agents | GitHub、公式ドキュメント | 週1回 | data/collected/tech/ |
| SNSトレンド | #生産性向上 #AIアシスタント #スケジュール管理 | X/Twitter | 日1回 | data/collected/social/ |
| 法規制 | 個人情報保護法、メール通信規制、GDPR | 官公庁サイト | 月1回 | data/collected/legal/ |
...
|-----------------|-----------|------|------|
| X/Twitter | @TaskMasterAI | 生産性Tips・時間管理術共有 | 要開設 |

### 投稿スケジュール
| 曜日 | 時間 | コンテンツタイプ |
|------|------|-----------------|
| 月-金 | 09:00, 18:00 | 価値提供投稿（時間管理Tips、メール効率化） |
| 土日 | 12:00 | 週間まとめ |
